...
/**
 * import search where we want to perform serching like index(frontpage) any_genre_language(movielist.js) detailofanymovie(detail.js)
 */

//search wrpper from movie-list.html
